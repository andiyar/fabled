...
**Status:** design brief — being expanded as THREE sequential plans (ledgered 2026-07-09): **4a** interactive surfaces & side inspector (features 2, 3, 1, 4, 5, 17) — **EXECUTED, merged to master 2026-07-10 (4d76919)**; **4b** shell & signals (13, 14, 15, 16, 18, 7 + liveness from 11) — **expanded 2026-07-11** as `2026-07-11-plan-4b-shell-and-signals.md` with conscious scope deltas ledgered in DECISIONS.md (effort control + thinking rendering, step grouping, task-tools checklist, design-language phase; feature 15 rescoped to disk reality); **4c** lifecycle, terminal & presets (6, 10, rest of 11, 12 — **feature 9 Cowork preset DROPPED, feature 8 Chat preset deferred pending Ben**; ledgered 2026-07-11). **Roadmap resequenced 2026-07-11 (DECISIONS "Post-4b roadmap"):** after the 4b gate come (a) a permission-mode spawn hotfix and (b) a mockup-driven design/interaction sprint, BEFORE the 4c expansion; 4c is re-prioritized friction-first and its expansion must consume every OPEN row of `../UX-LEDGER.md` — the digest alone is no longer the sole scope feed. Expand one at a time with superpowers:writing-plans (see `../COORDINATION.md`); tech-debt riders travel with their layer. CD-UI digest (`2026-07-10-cd-ui-digest.md`) feeds 4b/4c scope.
...
8. **Chat preset.** ~~"New chat" = session in `~/Library/Application Support/Fabled/chats/<uuid>/` scratch dir, tool chrome de-emphasized (tool cards start fully collapsed), composer-first layout.~~ **DEFERRED pending Ben's confirmation (2026-07-11 · pure-CC descope; DECISIONS.md).**
9. **Cowork preset.** ~~Folder picker + permission mode `acceptEdits` + a visible working-folder chip; background-running sessions listed in sidebar with progress; check-in flow = notification → click → review timeline.~~ **DROPPED (2026-07-11 · pure-CC descope; DECISIONS.md).**
